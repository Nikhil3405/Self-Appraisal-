...
export default function Category2C({ initialData, onFormDataChangeAction }: Category2CProps) {
  ...
  return (
    <div>
      ...
      <button
        type="button"
        onClick={addRow}
        disabled={totalScore >= 15}
        className={`mt-2 px-3 py-2 rounded text-white ${
          totalScore >= 15 ? "bg-gray-400 cursor-not-allowed" : "bg-indigo-500"
        }`}
      >
        + Add Row
      </button>
